...
(
    REQUEST_ID INTEGER,
    ITEM_ID    INTEGER,
    CONSTRAINT FK_ITEM_ITEMS FOREIGN KEY (ITEM_ID) REFERENCES ITEMS (ID) ON DELETE CASCADE,
    CONSTRAINT FK_REQUEST_REQUESTS FOREIGN KEY (REQUEST_ID) REFERENCES REQUESTS (ID) ON DELETE CASCADE,
...
(
    ...
    CONSTRAINT FK_COMMENT_ITEM FOREIGN KEY (ITEM_ID) REFERENCES ITEMS (ID) ON DELETE CASCADE ON UPDATE RESTRICT
);
