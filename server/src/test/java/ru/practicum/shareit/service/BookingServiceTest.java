...
public class BookingServiceTest {
    ...
    void allBookings_withCurrentState() {
        ...
        when(bookingRepository.getByBookerIdAndEndIsAfterAndStartBeforeOrderByStartDesc(anyInt(), any(), any(), any(Pageable.class)))
                .thenReturn(bookings);
    ...
    void allBookings_withFutureState() {
        ...
        when(bookingRepository.findByBookerIdAndStartAfter(anyInt(), any(), any()))
                .thenReturn(bookings);
